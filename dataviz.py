...
class DataVizWidget(QtGui.QMainWindow):
    ...
    def __setupActions(self):
        ...
        self.toggleRightDockAction = QtGui.QAction('Right dock', self)
        self.toggleRightDockAction.setCheckable(True)
        self.toggleRightDockAction.setChecked(True)
        self.connect(self.toggleRightDockAction, QtCore.SIGNAL('toggled(bool)'), self.rightDock.setVisible)
        self.toggleDataListAction = QtGui.QAction('Data list', self)
        self.toggleDataListAction.setCheckable(True)
        self.toggleDataListAction.setChecked(False)
        self.connect(self.toggleDataListAction, QtCore.SIGNAL('toggled(bool)'), self.dataList.setVisible)
    ...
    def __setupMenuBar(self):
        ...
        self.viewMenu.addAction(self.toggleRightDockAction)
...
#         pathlist.append(path)
    ...
    def __updateWindowMenu(self):
        ...
        self.viewMenu.addAction(self.toggleLeftDockAction)
        self.viewMenu.addAction(self.toggleRightDockAction)
        self.viewMenu.addAction(self.toggleDataListAction)
    ...
    def _plotSum(self):
        ...
        mdiChild.widget().addPlotCurveList([path], [(ts, sumdata)], curvenames=['summed %s ...' % (path)])
        self.connect(mdiChild.widget(), QtCore.SIGNAL('curveSelected'), self.__showStatusMessage)
        mdiChild.showMaximized()
